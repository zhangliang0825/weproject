...
#     r = await mysqlobj.query("SELECT title,link,str_date,media FROM cx0308 WHERE str_date BETWEEN 20210501 AND 20210515 AND post_type = 10")
#     return r
#
...
def weixin_main():
    ...
    if sigle[0] == '-1':
        ...
        for post_id, link, media in data_list:
            ...
            url = "http://192.168.0.218:9001/items/"
